...
/**
 * Crea un programa Java que muestre por pantalla un listado de eventos, junto con el número de asistentes, ubicación y dirección.
 */
public class Ej01 {
        ...
        try (Connection con = ds.getConnection()) {
            try (PreparedStatement stmt = con.prepareStatement(query)) {
                ...
                while (resultSet.next()) {
                    ...
                    System.out.println(evento + " | " + asistentes +
                            " | " + ubicacion + " | " + direccion);
                }
            }
        }
