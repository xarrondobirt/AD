...
/**
 * Crea un programa que permita registrar un asistente a un evento.
 * Se pedirá el dni. Se mostrará en consola el listado de eventos,
 * cada uno con un número y se le pedirá al usuario que elija el evento.
 * Si el dni no se encuentra en la BD se guarda en la tabla de asistentes.
 * Si el evento ya alcanzó su capacidad máxima (basado en la ubicación),
 * el programa debe negar la entrada. Se debe controlar que el dni tenga formato de 8 números y una letra seguido.
 */
public class Ej03 {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try (Connection con = ds.getConnection()) {
            ...
            try (PreparedStatement stmtSelectEventos = con.prepareStatement(queryEventos, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY)) {
